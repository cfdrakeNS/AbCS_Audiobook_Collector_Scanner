...
- F1 while selecting lists live shortcuts only (Alt+W, Update, Delete, Shift+arrows, Escape, column jumps, Alt+L, Alt+/).
...
3. Alt+U, Alt+D, F1, Alt+/ still work. F1 during selection omits blocked shortcuts.
