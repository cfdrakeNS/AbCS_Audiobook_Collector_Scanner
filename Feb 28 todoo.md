...
- Ensure ImportScanWorker (QThread) and signal-based scan logic remain in import_window.py for large import responsiveness.
...
- No changes needed in import_scanner.py or tag_reader.py for large import compatibility.
