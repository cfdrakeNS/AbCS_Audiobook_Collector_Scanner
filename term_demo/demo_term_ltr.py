...
class AS400Simulator:
    def __init__(self, root):
        ...
        # Container centers the screen
        self.container = tk.Frame(root, bg="#1A1A1A")
        self.container.pack()

        # The Text widget dictates the exact size of the window now
        ...
        self.text_area.bind("<ISO_Left_Tab>", self.tab_prev) 
    ...
    def build_screen(self):
        ...
        self.write(1, 26, "COMMERCIAL PORTFOLIO REVIEW", "label") 
        self.write(1, 70, "2026-05-02", "label") 

        # Row 3-6: Header Information 
        ...
        self.write(8, 0, "INSTRUMENT", "label")     
        self.write(8, 18, "BALANCE", "label")        
        self.write(8, 35, "RATE", "label")           
        self.write(8, 48, "MATURITY", "label")       
        self.write(8, 66, "TRANS #", "label")        

        # Rows 10-20: Data Rows 
        data = [
    ...
    def focus_field(self):
        ...
        self.text_area.see(f"{row}.{col}") 

if __name__ == "__main__":
    try:
        root = tk.Tk()
        
        # Prevent the user (or OS) from accidentally resizing and breaking the layout
