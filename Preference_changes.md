...
## 2\. flip author name; book\_list\_import, web\_metadat remove this completely

logic around comparison and normalization of author

## 3\. Move leading 'the', 'a', 'an' to end of title: remove this completely

modules: book\_list\_import, web\_metadata,
...
modules:  book\_list\_import, web\_metadat, book\_detail,  import\_detail, name\_list, collection, update

these module may also need changes.
validato, import\_rules.py, import\_scanner.py, validator.py
