...
class AS400Simulator:
    ...
    def build_screen(self):
        ...
        # Row 3-6: Header Information[cite: 2]
        ...
        # Expanded Data (Rows 11-17)[cite: 1, 2]
        data = [
