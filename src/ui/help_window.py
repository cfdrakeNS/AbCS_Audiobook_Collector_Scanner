...
class HelpWindow(AccessibleDialog):
    ...
    def __init__(
        ...
        # No auto-default buttons: pressing Enter in the help text pane must
        # not activate the first push button (zoom out) via QDialog defaults.
        for button in (self.zoom_out_button, self.zoom_in_button, self.close_button):
