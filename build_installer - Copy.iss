...
Source: "dist\AbCS\*.dll"; DestDir: "{app}"; Flags: ignoreversion ignoremissingfiles
Source: "dist\AbCS\*.pyd"; DestDir: "{app}"; Flags: ignoreversion ignoremissingfiles
Source: "dist\AbCS\*.txt"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\AbCS\_internal\abcdDB_def.sql"; DestDir: "{app}\data"; Flags: ignoreversion
Source: "dist\AbCS\data\Graphics\*"; DestDir: "{app}\Graphics"; Flags: ignoreversion recursesubdirs createallsubdirs
