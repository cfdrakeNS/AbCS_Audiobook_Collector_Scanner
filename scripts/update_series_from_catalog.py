...
Expected CSV columns (header names are stripped of padding):
  Author, Title (or title), Series, SeriesNumber (or Series No / Series No.)
"""
...
def load_catalog(csv_path: Path) -> Tuple[Dict[str, List[CatalogEntry]], int]:
    ...
    if reader.fieldnames:
        # Catalog exports sometimes pad headers (e.g. "title ").
