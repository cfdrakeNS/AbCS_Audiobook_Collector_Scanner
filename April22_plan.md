...
**Implementation Plan:**
### Options section 
1. Remove the "review clean book before adding" checkbox from the "Options" section 
 - check the entire app to ensure that all references are removed/changed 
2. Remove the "Flip Author Name" checkbox from the "Options" section  
	- DONE: Checkbox and all code references removed from Preferences window and logic (April 22, 2026). No references remain in UI or settings.
3. Remove the "Apply Proper Case" checkbox from the "Options" section  
	- DONE: Checkbox and all code references removed from Preferences window and logic (April 22, 2026). No references remain in UI or settings.
4. Remove the "Move Leading..." checkbox from the "Options" section  
	- DONE: Checkbox and all code references removed from Preferences window and logic (April 22, 2026). No references remain in UI or settings.
5. Remove the Options section group box and all related code from Preferences window.  
   - DONE: Options section group box, layout, and all code references removed from Preferences window and logic (April 22, 2026). No references remain in UI or settings.

### Auto-correct section 
6. Remove the "Trim whitespace" checkbox from the "Auto-correct" section  
	- DONE: Checkbox and all code references fully removed from Preferences window and logic (April 22, 2026, post-verification). UI, settings, and help text updated. No references remain in code or UI.
7. Remove the "Strip leading Punctuation" checkbox from the "Auto-correct" section 
	- DONE: Checkbox and all code references fully removed from Preferences window and logic (April 22, 2026, post-verification). UI, settings, and help text updated. No references remain in code or UI.
8. Remove the "Special characters" checkbox from the "Auto-correct" section 
	- DONE: Checkbox and all code references fully removed from Preferences window and logic (April 22, 2026, post-verification). UI, settings, and help text updated. No references remain in code or UI.
9. remove the section qbox for Auto-Correct" headers, textbox etc.
 - DONE: Entire Auto-Correct section group box, header, and all related layout code fully removed from Preferences window and logic (April 22, 2026, post-verification). No references remain in code or UI.

### Preferences win cleanup and checks 
10. Update the Preferences window layout to reduce height and whitespace, making it accessible and visually balanced at all zoom levels.
11. Update all help text, F1 dialogs, and shortcuts.py to reflect the new, simplified Preferences window
...
- Entry points audit (Preferences window): **DONE (April 22, 2026)**
	- All Preferences window entry points, shortcut registration, and focus logic validated. No legacy or missing references remain.
- Alt-letter shortcut audit (Preferences window): **DONE (April 22, 2026)**
	- Preferences window F1/help dialog updated to remove Options and Auto-Correction shortcuts. All displayed shortcuts now match the current UI.
- Alt-letter shortcut audit (Collection window): **DONE (April 22, 2026)**
	- All Alt-letter shortcuts (Alt+L, Alt+N, Alt+E, Alt+S, Alt+D) are registered, accessible, and match the help dialog and UI controls. No conflicts or missing assignments. Help dialog is accurate.
- **Testing needed:** F1 help must show correct shortcuts. Continue Alt-letter shortcut audit for other windows.
